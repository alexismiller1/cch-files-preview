import { Card, CardPreview, Content, Text, Badge } from "@react-spectrum/s2";
...
export function LayoutCard({ layout, index, onPress }: LayoutCardProps) {
  return (
    <Card variant="secondary" size="L" onPress={onPress}>
      <CardPreview>
        {layout.thumbnail ? (
          <img
          ...
          <div className={placeholderStyles[index % placeholderStyles.length]} />
        )}
      </CardPreview>
      <Content>
